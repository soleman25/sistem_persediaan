...
<div class="container">
    <div class="row">
        <div class="col-sm-12"> 
             <div class="card">
                <div class="card-body">
                        <?=  form_open('om/report/data_order') ?>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?php echo base_url()?>om/report/print_order" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                                        <a href="<?php echo base_url()?>om/report/pdf_order" class="btn btn-default" target="blank"><i class="fa fa-download"></i> PDF</a>
                                    </div>
                                </div>
                            </form>
                   </div>
