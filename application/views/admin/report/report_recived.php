                        ...
                        <?=  form_open('om/report/data_recived') ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?php echo base_url()?>admin/report/print_recived" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                                        <a href="<?php echo base_url()?>admin/report/pdf_recived" class="btn btn-default"><i class="fa fa-download"></i> PDF</a>
                                    </div>
                                </div>
                            </form>
                   </div>
