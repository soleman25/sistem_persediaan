                        ...
                        <?=  form_open('om/report/data_retur') ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?php echo base_url()?>admin/report/print_retur" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                                        <a href="<?php echo base_url()?>admin/report/pdf" class="btn btn-default"><i class="fa fa-download"></i> PDF</a>
                                    </div>
                                </div>
                            </form>
                   </div>
        ...
        <div class="col-sm-12"> 
            <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title text-center">Report Retur</h4>
                </div>
